...
// Estático: fuera del componente para que no se recree en cada render.
...
const MinimalHero = () => {
  ...
  return (
    <div className="min-h-screen w-full overflow-hidden bg-gradient-to-br from-purple-100 via-pink-50 to-purple-100 relative">
      {/* Floating Navigation */}
      <div className="absolute top-6 left-1/2 transform -translate-x-1/2 z-50">
        <nav className="bg-white/80 backdrop-blur-md rounded-2xl px-6 py-3 shadow-lg border border-white/20">
          <div className="flex items-center gap-8 md:gap-36">
            <div className="flex items-center space-x-2">
              <div className="w-7 h-7 bg-black rounded-full flex items-center justify-center">
                <div className="w-5 h-5 border-2 border-white rounded-full relative">
                  <div className="absolute inset-0.5 border border-white rounded-full" />
                </div>
              </div>
            ...
            <button
              type="button"
              className="bg-black text-white px-4 py-2 rounded-lg hover:bg-gray-800 transition-all duration-200 transform hover:scale-105 flex items-center space-x-1 text-sm"
            >
              <span>Login</span>
      ...
      <div className="flex flex-col items-center justify-center px-6 pt-40 pb-16 max-w-7xl mx-auto">
        ...
        <div className="relative w-full max-w-3xl mx-auto">
          ...
          <div className="absolute inset-0 transform rotate-3 scale-95 transition-all duration-1000 ease-in-out">
            <div
              className={`w-full h-72 bg-orange-300 rounded-3xl shadow-2xl opacity-50 transition-all duration-1000 ${
          ...
          <div className="absolute inset-0 transform -rotate-2 scale-[0.96] transition-all duration-1000 ease-in-out delay-300">
            <div
              className={`w-full h-[19rem] bg-purple-400 rounded-3xl shadow-2xl opacity-60 transition-all duration-1000 ${
          ...
          <div className="absolute inset-0 transform rotate-1 scale-[0.97] transition-all duration-1000 ease-in-out delay-500">
            <div
              className={`w-full h-72 bg-pink-400 rounded-3xl shadow-2xl opacity-50 transition-all duration-1000 ${
          ...
          <div className="absolute inset-0 transform -rotate-1 scale-[0.98] transition-all duration-1000 ease-in-out delay-700">
            <div
              className={`w-full h-72 bg-yellow-300 rounded-3xl shadow-2xl opacity-40 transition-all duration-1000 ${
          ...
          {/* Main Animated Card */}
          <div
            className={`relative z-10 w-full h-[19rem] ${currentConfig.bgColor} rounded-3xl shadow-2xl p-6 flex flex-col transition-all duration-1000 ease-in-out transform hover:scale-[1.02]`}
          >
            {/* Chat Interface */}
            <div className="bg-white/25 backdrop-blur-sm rounded-2xl p-5 flex-1 transition-all duration-500 overflow-y-auto">
              {/* Chat Header */}
                            ...
                            <div className="w-12 h-12 rounded-xl bg-purple-500 flex items-center justify-center mb-2">
                              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
                                  ...
                                  strokeLinejoin="round"
                                  strokeWidth={2}
                                  d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M12 21v-1m-3.364-3.364l-.707-.707m2.828-2.828l.707-.707M11 13H7a4 4 0 00-4 4v2a2 2 0 002 2h14a2 2 0 002-2v-2a4 4 0 00-4-4h-4z"
                                />
                              </svg>
                            </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <div className="flex justify-between mb-2">
                          ...
                          <span className="text-sm text-black/70 tabular-nums">14,280 / 50,000</span>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-white/20 rounded-xl p-3">
                          ...
                          <div className="text-xl font-bold text-black/90 tabular-nums">35,720</div>
                          <div className="text-xs text-green-500 mt-1">≈ 1,786 requests</div>
                        </div>

                        <div className="bg-white/20 rounded-xl p-3">
                          <div className="text-xs text-black/60 mb-1">Reset in</div>
                          <div className="text-xl font-bold text-black/90 tabular-nums">23h 59m</div>
        ...
        <div className="flex space-x-2 mt-8">
          {cardConfigs.map((_, index) => (
            <button
              ...
              aria-label={`Show card ${index + 1} of ${cardConfigs.length}`}
